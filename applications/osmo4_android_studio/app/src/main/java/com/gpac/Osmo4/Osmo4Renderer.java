...
public class Osmo4Renderer implements GLSurfaceView.Renderer {
    ...
    private final int deviceOrientationPortrait;
    ...
    public void onSurfaceCreated(GL10 gl, EGLConfig config) {
        if (instance == null) {
            try {
                ...
                instance = new GPACInstance(callback, 320, 430, gpacConfig, urlToLoad, deviceOrientationPortrait);
     ...
     */
    public Osmo4Renderer(GpacCallback callback, GpacConfig gpacConfig, String urlToLoad, int deviceOrientationPortrait) {
        this.callback = callback;
        this.urlToLoad = urlToLoad;
        this.gpacConfig = gpacConfig;
        this.deviceOrientationPortrait = deviceOrientationPortrait;
    }
    ...
    public void onDrawFrame(GL10 gl) {
        if (instance != null) {
            ...
            //    Log.d(LOG_RENDERER, "Frames Per Second = " + ((now - startFrame) / 1000) + " fps"); //$NON-NLS-1$//$NON-NLS-2$
                this.startFrame = now;
            }
            instance.render();
        }
