...
public class GPACInstance implements GPACInstanceInterface {
    ...
    synchronized static Map<String, Throwable> loadAllLibraries(GpacConfig config) {
        ...
        final String[] toLoad = { "GLESv2", "log",//$NON-NLS-3$ //$NON-NLS-2$ //$NON-NLS-1$
                                 ...
                                 "gpacWrapper",
                                 "opencv_java", "gm_loc_img"}; // //$NON-NLS-1$ //$NON-NLS-2$
     ...
     */
    public GPACInstance(GpacCallback callback, int width, int height, GpacConfig config, String urlToOpen, int deviceOrientationPortrait)
            throws GpacInstanceException {
        StringBuilder sb = new StringBuilder();
        ...
        try {
            Log.i(LOG_LIB, "Device default orientation is portrait: " + (deviceOrientationPortrait == 1));
            handle = createInstance(callback,
                                    ...
                                    urlToOpen,
                                    Integer.toString(deviceOrientationPortrait));
        } catch (Throwable e) {
    ...
    private native long createInstance(GpacCallback callback, int width, int height, String cfg_dir,
            String modules_dir, String cache_dir, String font_dir, String gui_dir, String url_to_open, String deviceOrientationPortrait);
